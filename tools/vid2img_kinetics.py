...
def class_process(dir_path, dst_dir_path, class_name):
    ...
    worker = partial(vid2jpg, class_path=class_path,
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        ...
        "python vid2img_kinetics.py ../../kinetics-downloader/dataset/train "
    ...
    parser.add_argument("--dst_dir", type=str, required=True,
                        help="destination directory where folders named with"
                        " classes will be created and images will be created"
                        "for each video.")
...
if __name__ == "__main__":
    args = parse_args()
    dir_path = args.src_dir
    dst_dir_path = args.dst_dir
